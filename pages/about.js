      ...
      <AnimatePresence exitBeforeEnter>
        ...
        >
          ...
          <AboutBlock title="The Flugel Fam">
            <p>
              Flugelhorn{" "}
              <span className={style.pronounce}>/ˈflo͞oɡəlˌhôrn/</span> is a
              design oriented digital web agency founded by the deadly duo,
              Ninja Labor and Wizard Erixon.
            </p>
            <p>
              ...
              <i>
                ...
                transformative learning experiences to help them adapt to
          ...
          <AboutBlock title="What we do">
            <p>
              We design and develop mesmerizing digital products for companies
              and organizations. Always responsive, always search engine
              optimized, always stunning.
            </p>
            <p>
              We have the capacity to create everything between business
              websites to complex full blown web apps. Whether you need a
              website for your restaurant with a changeable menu or an online
              event with login and live chat, we can do it.
            </p>
          ...
          <AboutBlock title="Our Office">
            ...
            <p>
              This philosophy is reflected in the work we do. We take
              inspiration from everything between the minimalistic interior
              design of Sweden to the the colorful fabrics woven by the Maya
              people of Guatemala. By utilizing the things we see and explore
              we're able to create creative and tailor-made solutions.
            </p>
            <br />
            <br />
            <div>
